...
import SkeletonMoviecard from "../../../components/Skeletons/SkeletonMovieCard/SkeletonMoviecard.jsx";
        ...
        <div className="w-screen h-full flex justify-center items-center">
          <div className="w-full h-full">
            <div className="m-auto w-[90%]">
              <h3 className="text-2xl text-white font-normal">Latest movies</h3>
              <div className="my-5">

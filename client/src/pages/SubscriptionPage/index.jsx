...
const SubscriptionPage = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      const response = await axiosInstance.post(`/users/buy-subscription`, {
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      dispatch(updateUser({ isSubscriber: false, subscriptionId: "" })).then(
        () => {
  ...
  return (
    <div className="min-h-screen py-12 bg-background1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-background2 text-primary_text shadow-xl rounded-lg p-8">
          ...
          <p className="mt-4 text-center text-secondary_text">
            Enjoy unlimited access to our collection of Bengali movies by
            subscribing for just ₹50 per month.
          </p>
          ...
          <div className="mt-8">
            ...
            <ul className="mt-4 space-y-2 text-secondary_text">
              ...
              <li>• Exclusive content available only to subscribers</li>
            ...
            <div className="mt-4 space-y-4">
              <div className="bg-background1 p-4 rounded-lg shadow-md">
                <p className="text-secondary_text">
                  "This is the best platform for Bengali movies. The
                  subscription is totally worth it!"
                </p>
                <p className="mt-2 text-sm text-secondary_text">- Chandrima</p>
              </div>
              <div className="bg-background1 p-4 rounded-lg shadow-md">
                <p className="text-secondary_text">
                  "I love the collection and the quality of streaming is
                  excellent."
                </p>
                <p className="mt-2 text-sm text-secondary_text">- Roshan</p>
              </div>
              <div className="bg-background1 p-4 rounded-lg shadow-md">
                <p class="text-secondary_text">
                  "Finally, a streaming platform that understands Bengali
                  cinema! The curation is fantastic, and I've discovered so many
                  hidden gems."
                </p>
                <p class="mt-2 text-sm text-secondary_text">- Pratik</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="bg-background1 p-4 rounded-lg shadow-md">
                ...
                <p className="text-secondary_text">
                  Yes, you can cancel your subscription anytime you want.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="App">
        {!showModal && (
          <button
            className="fixed bottom-1/2 transform translate-y-1/2 rotate-90 bg-highlight hover:bg-highlight_hover text-primary_text tracking-widest font-semibold px-4 rounded-xl transition-all duration-300
        ...
        {showModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-background1 bg-opacity-50 transition-opacity duration-300">
            <div className="bg-shadow text-primary_text rounded-lg p-6 sm:w-full max-w-lg shadow-lg transform transition-all duration-300 scale-105">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label className="block text-secondary_text text-lg font-bold mb-2">
                  ...
                  <div className="flex space-x-2">
                    {["😃", "😊", "😐", "☹️", "😠"].map((emoji) => (
                      <button
                        ...
                        key={emoji}
                        className={`text-2xl ${
                          formData.experience === emoji
                            ? "border border-highlight rounded-full p-2"
                            : ""
                        }`}
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    onChange={handleFeedbackChange}
                    className="shadow appearance-none border rounded w-full py-2 px-3 bg-background1 text-primary_text leading-tight focus:outline-none focus:shadow-outline h-32"
                    required
                  ></textarea>
                </div>
                <div className="flex items-center justify-between">
                  <button
                    type="button"
                    className="bg-gray-500 hover:bg-gray-700 font-ubuntu font-semibold text-primary_text py-2 px-4 rounded-lg mr-2 transition-all duration-300"
                  ...
                  {submitting ? (
                    <button
                      type="submit"
                      className="bg-highlight hover:bg-highlight_hover font-ubuntu font-semibold text-primary_text py-2 px-4 rounded-lg transition-all duration-300 cursor-not-allowed "
                    >
                      Submitting...
                    </button>
                  ) : (
                    <button
                      type="submit"
                      className="bg-highlight hover:bg-highlight_hover font-ubuntu font-semibold text-primary_text py-2 px-4 rounded-lg transition-all duration-300"
                    >
                      Submit
                    </button>
                  )}

  ...
  return (
    <div className="bg-black">
      ...
      <div className="relative w-full bg-cover bg-center xl:h-[75vh] lg:h-[58vh] sm:h-[55vh] h-[32vh] bg-background1">
        {/* Content Skeleton */}
        <div className="flex flex-row h-ful gap-5 p-5 xl:pt-40 md:pt-10 sm:pt-7">
          ...
          <div className="h-auto lg:ml-24 md:ml-16 sm:ml-5 ml-1 flex flex-col justify-center items-center xl:w-1/5 lg:w-1/4 md:w-1/5 sm:w-1/4 w-2/5">
            <div className="lg:w-64 xl:h-96 lg:h-72 md:h-56 md:w-48 sm:h-40 sm:w-32 w-24 h-28 mb-5 mt-3 p-2 rounded-xl bg-shadow animate-pulse"></div>
            <div className="lg:w-64 lg:h-12 md:w-40 sm:h-8 sm:w-32 w-24 h-6 mb-3 rounded-lg bg-shadow animate-pulse"></div>
          </div>

          {/* Skeleton for the right side (details) */}
          <div className="flex flex-col justify-center items-start xl:w-2/5 lg:w-2/4 md:w-3/5 sm:w-2/4 lg:gap-5 md:gap-y-[2px] sm:gap-1">
            <div className="lg:w-1/2 lg:h-10 sm:w-1/3 md:h-8 sm:h-6 lg:mb-6 sm:mb-4 h-6 w-1/3 mb-2 rounded-lg skeleton-box bg-shadow"></div>

            <div className="flex flex-row items-center gap-2">
              {/* <div className="w-6 h-6 bg-shadow"></div> */}
              <div className="sm:w-40 sm:h-7 w-36 h-7 md:w-0 md:h-0 skeleton-box bg-shadow rounded-lg animate-pulse"></div>
            ...
            <div className="flex flex-row items-center gap-6 lg:py-3 md:py-1 sm:py-2 py-2">
              <div className="sm:w-56 sm:h-7 w-40 h-7 md:w-0 md:h-0 skeleton-box bg-shadow rounded-lg animate-pulse"></div>
              <div className="md:w-24 md:h-7 skeleton-box bg-shadow rounded-lg animate-pulse"></div>
            ...
            <div className="lg:w-36 lg:h-8 md:w-24 md:h-6 sm:w-20 sm:h-4 w-16 h-4 bg-shadow rounded-lg skeleton-box"></div>
          </div>
        </div>
      </div>
      ...
      <div className="xl:px-24 lg:px-20 md:px-10 sm:px-5 px-0 mt-0 xl:mt-10 lg:mt-5 flex flex-col gap-4">
        <div className="text-left flex flex-col gap-5 common-container">
          <div className="sm:w-48 sm:h-12 w-36 h-8 mb-4 rounded-lg bg-shadow"></div>
          <div className="w-full h-16 mb-2 rounded-lg bg-shadow"></div>
        </div>
